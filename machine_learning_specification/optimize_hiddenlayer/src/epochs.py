...
/train_ffnns/data/lane_change_training_data.csv
...
# Itterate over epochs and train the neural network and save the history in a CSV file.
for i in range(1, 2):
    epochs = 40 + 10 * i
    name = 'epochs_' + str(epochs) + '.csv'
    ...
    history_cb = model.fit(training_dataset, epochs=epochs,
